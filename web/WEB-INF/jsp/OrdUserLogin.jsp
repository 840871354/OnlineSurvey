...
<html>
    ...
    <body>
        <div class="Header">
            ...
            <form action="ordinaryUser/login" method="get">
                <div class="login"><br>
                    <label>
                        <p> <font  size= 5;face="Yu Gothic Light"> <span class="login1">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <a   style="text-decoration:none; color:#000">个人用户 </a></font> <font  size= 5;face="Yu Gothic Light" > 
                                                                                                           <span class="login2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <a  href="CorUserLogin" style="text-decoration:none; color:#999">企业用户 </a></font> </p>
                    </label>
                    <br>
