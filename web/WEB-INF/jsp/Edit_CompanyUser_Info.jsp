...
//            }
    ...
    <body>
        <form action="corporateUser/Edit_CompanyUser_Info" method="post" enctype="multipart/form-data">
            <div class="Header">
            ...
            <div class="Registered">
                ...
                <div class="inputinfo">
                    <c:forEach items="${corporateUser}" var="c" varStatus="cu">
                        <input type="text" name="name" value="${c.cuName}" readonly="readonly"><br/><br/>
